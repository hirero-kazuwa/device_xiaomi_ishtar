...
function blob_fixup() {
    case "${1}" in
        odm/etc/camera/enhance_motiontuning.xml | odm/etc/camera/night_motiontuning.xml | odm/etc/camera/motiontuning.xml | odm/overlayfs/ishtar/odm/etc/camera/enhance_motiontuning.xml |odm/overlayfs/ishtar/odm/etc/camera/night_motiontuning.xml | odm/overlayfs/ishtar/odm/etc/camera/motiontuning.xml)
            sed -i 's/<?xml=/<?xml /g' "${2}"
            ;;
        odm/lib64/hw/displayfeature.default.so)
            "${PATCHELF}" --replace-needed "libstagefright_foundation.so" "libstagefright_foundation-v33.so" "${2}"
            ;;
        odm/lib64/hw/vendor.xiaomi.sensor.citsensorservice@2.0-impl.so | odm/overlayfs/ishtar/odm/lib64/hw/vendor.xiaomi.sensor.citsensorservice@2.0-impl.so)
            ...
            ;;
        odm/lib64/libailab_rawhdr.so | odm/lib64/libxmi_high_dynamic_range_cdsp.so | odm/overlayfs/ishtar/odm/lib64/libailab_rawhdr.so | odm/overlayfs/ishtar/odm/lib64/libxmi_high_dynamic_range_cdsp.so)
